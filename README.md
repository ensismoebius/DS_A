...
| Caminho | Descrição |
|---------|-----------|
| `javafxLinux_A/`   | Projeto Eclipse/VS Code + SDK JavaFX para Linux empacotado |
| `javafxWindows_A/` | Projeto Eclipse/VS Code + SDK JavaFX para Windows empacotado |
...
Abra `javafxLinux_A` (ou `javafxWindows_A`) no Eclipse ou no VS Code e execute
